...
export * from './components/modal/appointment-view.component';
export * from './components/modal/shift-view.component';
...
export * from './components/modal/inventory-view.component';
